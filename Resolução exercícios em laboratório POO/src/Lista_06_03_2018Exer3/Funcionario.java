...
public class Funcionario extends Pessoa {
	...
	public Funcionario(String nome, String sobrenome, int matricula2, double salario2) {
	}

	// metodo assinatura com condiçao
	...
	// metodo assinatura primeira parcela
	public double getSalarioPrimeiraParcela() {
		double percentual = 0.6;		
		return salario * 0.6;
	}

	// metodo assinatura segunda parcela
